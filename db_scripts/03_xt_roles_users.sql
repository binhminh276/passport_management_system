...
-- Chay bang SYS AS SYSDBA: cap quyen nen tang cho ROLE_CD, APP_GUEST va SEC_MGR.
...
GRANT ADMINISTER ROW LEVEL SECURITY POLICY ON SCHEMA PASSPORT_APP TO SEC_MGR;
...
-- Chay bang SEC_MGR: tao function va gan VPD ROLE_CD cho PASSPORT_DATA.
...
-- Chay bang SEC_MGR: tao function va gan VPD ROLE_CD cho PASSPORT_REQUEST_HISTORY.
